...
- แอดหญิง (female): 'ช่าย ละก็มีห้่าง Central Park เปิดใหม่ด้วย อยากไป'
- แอดต๊อบ (male): 'เดี๋ยวอ่านข่าวเสร็จแล้วไปกัน'
- แอดหญิง (female): 'กู๊ดดด งั้นไปกันฟังเล้ย จะไปเที่ยวละ' (giggling)
