# TODAY
Thu, 11 Sep 2025 12:54:46 +0700
- ฝนยังไม่ตก แต่ชอบตกเย็นๆ ทุกทีอ่ะ
- Apple events, new iPhone 17, Live Translation works when paired with an Apple Intelligence–enabled iPhone running iOS 26 and later. // อยากได้
...
## Intro
- INSTRUCTION: For the '[DYNAMIC GREETING]' placeholder, generate a short, casual Thai greeting appropriate for the day of the week based on the provided 'TODAY' date, optionally with a short, related, fun comment (e.g., 'สวัสดีวันศุกร์จ้า อยากกลับบ้านแล้ว ฮ่าๆๆ'). Use below as a rough idea guide for how to intro.
- Both: '[DYNAMIC GREETING] welcome to Noob Learning ที่ๆ เราจะ vibe learning ไปด้วยกัน! เย้~'
- แอดหญิง: 'พบกับแอดหญิง ai ปลอมตัวมา' (giggling)
- แอดต๊อบ: 'และแอดต๊อบ ai ปลอมตัวมา'
- แอดต๊อบ: 'วันนี้มีข่าว AI ใหม่ๆ มาอัปเดตกันอีกแล้ว'
- แอดหญิง: 'ไปกันฟังเล้ย'
- แอดต๊อบ: 'ไปกัน!'
...
- แอดต๊อบ & แอดหญิง: "และนี่ก็คือรายการ Noob Learning, ที่ๆ เราจะ vibe learning ไปด้วยกัน! เย้~ สวัสดีครับ/ค่ะ!"
- แอดหญิง: "ไปละน้าาาา"
- แอดต๊อบ: "บ๊ายบาย"
